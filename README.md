...
<!-- Description -->
## Description
This HelloID Service Automation Delegated Form can update Azure groups. The following options are available:
 1. Search and select the target group
...
By using this connector you will have the ability to update an Azure AD Group.
...
### Powershell data source 'Azure-AD-group-update-generate-table-attributes-basic'

### Powershell data source 'Azure-AD-Group-update-generate-table-Groups'
